...
SNP_file_name = paste(base.dir, "/SNP_all.txt", sep="") #获取SNP文件位置

expression_file_name = paste(base.dir, "/GE_all.txt", sep="") #获取基因表达量文件位置

# covariates_file_name = character() #
covariates_file_name = paste(base.dir, "/Covariates_all.txt", sep="") #读取协变量文件 #
